...
const DISCIPLINE_PATTERNS = [
  ...
  { pattern: /\(W&G\)$/i, discipline: 'Welding & Grinding', code: 'W&G', order: 5 },
  { pattern: /\(RT&L\)$/i, discipline: 'Rail Testing', code: 'RTL', order: 6 },
  { pattern: /\(D&P\)$/i, discipline: 'Distribution & Plant', code: 'D&P', order: 7 },
  { pattern: /\(E&P\)$/i, discipline: 'Electrical & Power', code: 'E&P', order: 8 },
  { pattern: /\(S&TME\)$/i, discipline: 'Signals', code: 'SIG', order: 2 },
  { pattern: /\(SIGELP\)$/i, discipline: 'Signals ELP', code: 'ELP', order: 10 },
  { pattern: /\(CRE\)$/i, discipline: 'Civil Engineering', code: 'CRE', order: 11 },
  { pattern: /\(PLANT\)$/i, discipline: 'Distribution & Plant', code: 'D&P', order: 7 },
  { pattern: /\(DISTRIBUTION\)$/i, discipline: 'Distribution & Plant', code: 'D&P', order: 7 },
  { pattern: /\(ATG\)$/i, discipline: 'Track', code: 'TRA', order: 1 },
